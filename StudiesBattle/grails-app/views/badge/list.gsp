			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="nom" title="${message(code: 'badge.nom.label', default: 'Nom')}" />
				...
				<g:each in="${badgeInstanceList}" status="i" var="badgeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${badgeInstance.id}">${fieldValue(bean: badgeInstance, field: "nom")}</g:link></td>
