	...
	<body>
		...
		<div id="show-badge" class="content scaffold-show" role="main">
			...
			<ol class="property-list badge">
				...
				<g:if test="${badgeInstance?.nom}">
				<li class="fieldcontain">
					<span id="nom-label" class="property-label"><g:message code="badge.nom.label" default="Nom" /></span>
					
						<span class="property-value" aria-labelledby="nom-label"><g:fieldValue bean="${badgeInstance}" field="nom"/></span>
