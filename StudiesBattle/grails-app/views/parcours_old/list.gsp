	...
	<body>
		...
		<div id="list-parcours" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="nom" title="${message(code: 'parcours.nom.label', default: 'Nom')}" />
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${parcoursInstanceList}" status="i" var="parcoursInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${parcoursInstance.id}">${fieldValue(bean: parcoursInstance, field: "nom")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${parcoursInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
